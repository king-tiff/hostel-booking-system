<template>
    <AuthenticatedLayout>
        ...
        <div class="p-6 bg-white rounded-lg shadow-md mb-6">
            ...
            <Link :href="route('admin.hostels.index')" class="text-blue-500"
...
const submitForm = () => {
    form.post(route("admin.hostel.addImage", props.hostel.id));
};
...
const deleteImagePost = (imageId) => {
    form.delete(route("admin.hostel.deleteImage", imageId), {
        preserveScroll: true,
