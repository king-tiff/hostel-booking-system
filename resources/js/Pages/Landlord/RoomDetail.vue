<template>
    <AuthenticatedLayout>
        ...
        <div class="p-6 bg-white rounded-lg shadow-md mb-6">
            ...
            <Link :href="route('landlord.rooms.index')" class="text-blue-500"
                >Back to Rooms</Link
            >
        </div>
...
const submitForm = () => {
    form.post(route("landlord.room.addImage", props.room.id));
};
...
const deleteImagePost = (imageId) => {
    form.delete(route("landlord.room.deleteImage", imageId), {
        preserveScroll: true,
